...
\begin{itemize}
	...
	\begin{itemize*}
        \item GPA: 3.88/4.00
		\item Relevant coursework includes Advanced Computer Networks (CS 740), Advanced Operating Systems (CS 736), Advanced Algorithms (CS 787), and Machine Learning (CS 760).
	\end{itemize*}
    \item 
	\headerrow
